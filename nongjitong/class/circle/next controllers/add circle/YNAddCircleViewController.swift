//
//  YNAddCircleViewController.swift
//  nongjitong
//
...
class YNAddCircleViewController: UIViewController, YNAskQuestionTextCollectionViewCellDelegate, YNAskQuestionImageCollectionViewCellDelegate, YNFinishInputViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UIActionSheetDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, YNTitleCollectionViewCellDelegate {
    ...
    func sendDataToserver() {
        ...
        let params: [String: String?] = ["m": "Appapi",
            ...
            "a": "create",
            "user_id": userId,
            "announcement": self.textViewText,
