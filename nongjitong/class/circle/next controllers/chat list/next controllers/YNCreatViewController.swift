...
class YNCreatViewController: UIViewController, YNAskQuestionTextCollectionViewCellDelegate, YNAskQuestionImageCollectionViewCellDelegate, YNFinishInputViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UIActionSheetDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, YNTitleCollectionViewCellDelegate {

    var classId: String?
    
    var groupId: String?
    
    init(calssId: String, group_id: String) {
    
        super.init(nibName: nil, bundle: nil)
        
        self.classId = calssId
